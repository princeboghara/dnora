...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showToast("Account created successfully. Welcome to DNORA.", "success");
      ...
      <div className="w-full max-w-md space-y-8 bg-white p-8 sm:p-10 rounded-sm border border-[#E8E5DE] shadow-sm">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-xs text-[#73706A]">
            Join our exclusive client registry for personalized concierge and order management.
          </p>
        </div>

        {/* Error notification */}
        {error && (
          <div className="p-3 bg-[#FCF0F0] border border-[#F5C2C2] text-xs text-[#C53030] rounded-sm">
            {error}
          </div>
        )}
